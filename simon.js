...
function clickRed() {
        ...
        $("#red").bind("touchstart", function (e) {
            if (statePlayColors == true) {
            $(this).css("background-color", "#ff4c4c");
            audioRed.play();
            userSequence[userTurns] = 0;
...
function clickGreen() {
        ...
        $("#green").bind("touchstart", function (e) {
            if (statePlayColors) {
            $(this).css("background-color", "#13ff7c");
            audioGreen.play();
            userSequence[userTurns] = 1;
        ...
        $("#green").bind("touchend", function (e) {
            $(this).css("background-color", "#00a74a");
        });
}
...
function clickBlue() {
        ...
        $("#blue").bind("touchstart", function (e) {
            if (statePlayColors) {
            $(this).css("background-color", "#1c8cff");
            audioBlue.play();
            userSequence[userTurns] = 2;
...
function clickYellow() {
        ...
        $("#yellow").bind("touchstart", function (e) {
            if (statePlayColors) {
            $(this).css("background-color", "#fed93f");
            audioYellow.play();
            userSequence[userTurns] = 3;
        ...
        $("#yellow").bind("touchend", function (e) {
            $(this).css("background-color", "#cca707");
        });
}
...
function beep(num) {
    ...
    setTimeout(function() {
        $(colors[num]).css("background-color", colorNormal[num])}, duration2);
    audios[num].play();
}
